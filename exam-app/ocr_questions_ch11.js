const ch11Questions = [
  ...
  },
  {
    ...
    "type": "single",
    "difficulty": "medium",
    "content": "4、2023 年5月第12题（此题常规重点考题，建议举一反三）\n（12） 是防止非法实体对交换数据的修改、插入、删除以及在数据交换过程中的数据丢失。",
    "options": [
      "对等实体认证服务",
      "数据保密服务",
      "数据完整性服务",
  ...
  },
  {
    ...
    "type": "single",
    "difficulty": "medium",
    "content": "6、（  ）是考虑各种具体的技术实现因素，进行数据库体系结构设计，真正实现数据在数据库中的存放。",
    "options": [
      "概念模型",
      "逻辑模型",
      "物理模型",
